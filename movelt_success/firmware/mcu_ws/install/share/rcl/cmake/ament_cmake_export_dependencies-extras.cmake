...
set(_exported_dependencies "ament_cmake;rcl_interfaces;rmw_implementation;rmw;rcutils;rosidl_runtime_c;tracetools")
    ...
    if(NOT "${${_dep}_TARGETS}" STREQUAL "")
      foreach(_target ${${_dep}_TARGETS})
        ...
        if(TARGET "${_target}")
          ...
          if(_include_dirs)
            list_append_unique(rcl_INCLUDE_DIRS "${_include_dirs}")
          endif()
