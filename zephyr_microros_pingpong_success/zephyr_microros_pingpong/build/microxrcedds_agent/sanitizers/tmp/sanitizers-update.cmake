...
if(git_update_strategy MATCHES "^REBASE(_CHECKOUT)?$")
  ...
  if(current_branch STREQUAL "")
    ...
    execute_process(
      COMMAND "/usr/bin/git" for-each-ref
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      _ep_message_quiet_capture(FATAL_ERROR
        "\nFailed to rebase in: '/home/marlar/zephyr_microros_pingpong_success/zephyr_microros_pingpong/build/microxrcedds_agent/sanitizers/src/sanitizers'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      _ep_accumulate_captured_output()
      _ep_message_quiet_capture(FATAL_ERROR
        "Failed to unstash changes in: '/home/marlar/zephyr_microros_pingpong_success/zephyr_microros_pingpong/build/microxrcedds_agent/sanitizers/src/sanitizers'.\n"
        "You will have to resolve the conflicts manually"
      )
    endif()
  endif()
